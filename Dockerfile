...
ENV ENABLED_DELETE_WATCHED_TV='0'
ENV ENABLED_MOVE_LIVE_TV='0'
ENV ENABLED_DELETE_OLD_TV='0'
...
RUN chmod -R 777 /app && chmod 644 /etc/logrotate.d/plexcleaner.conf && ln -sf /usr/share/zoneinfo/$TZ /etc/localtime
